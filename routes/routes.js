...
router.route("/cars/getOnePost").post(authenticateMiddleware.authenticate, carController.getPostById);
router
	.route("/cars/mycars")
...
router
	...
	.post(authenticateMiddleware.authenticate, upload.single("updateCarImg"), carController.editCarInfo);
